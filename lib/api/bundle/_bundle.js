...
async function bundleAll(debug = false) {
    ...
    await bundlerComponentJS.apply(getSrcPath("background", "js"), "background.js", debug);
    await bundlerComponentTS.apply(getSrcPath("content", "ts"), "content.js", debug);
    await bundlerComponentJS.apply(getSrcPath("content", "js"), "content.js", debug);
    await bundlerComponentTS.apply(getSrcPath("shared", "ts", "shared"), "shared.js", debug);
    await bundlerComponentJS.apply(getSrcPath("shared", "js", "shared"), "shared.js", debug);
    ...
    await Promise.all(TARGET_DIRS
        ...
        await bundlerComponentJS.apply(getTargetSrcPath("js"), getDistPath("js"), debug);
