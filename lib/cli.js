...
import { retrieveAvailableUpdate } from "./update.js";
 ...
 */
const print = (message, replaceLastLine = false, subtle = false) => {
    console.log(`${replaceLastLine ? `\x1b[1A\x1b[2K` : ""}\x1b[2m[${new Date().toLocaleString(Intl.DateTimeFormat().resolvedOptions().locale, {
