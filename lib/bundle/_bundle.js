...
import { ROOT_PATH, SRC_PATH, DIST_PATH, TARGET_DIRS, ASSETS_PATH, ASSETS_DIR } from "../constants.js";
...
export async function bundle(debug = false) {
    ...
    existsSync(ASSETS_PATH)
        && await cp(ASSETS_PATH, join(DIST_PATH, ASSETS_DIR), { recursive: true });
